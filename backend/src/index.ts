...
import { groupMembersTable, groupMessagesTable, notificationsTable, reelsTable, reelLikesTable } from "@workspace/db";
...
// --- Missing routes added here so no other files need to change ---
